<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="profile.aspx.cs" Inherits="twolayer2.profile" %>
        ...
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td class="auto-style3">
                        <asp:Image ID="Image1" runat="server" Height="134px" Width="115px" />
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                            ...
                            <ItemTemplate>
                                <table class="auto-style1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Image ID="Image2" runat="server" Height="93px" ImageUrl='<%# Eval("photo") %>' Width="97px" />
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    </tr>
